...
app.post('/todo/save', (req, res) => {
  if (req.body && req.body.id && Number(req.body.id) > 0) {
...
app.post('/todo/updateStatus/:id', TodoController.updateStatus)
app.post('/todo/updateStatus', (req, res) => {
  if (req.body && req.body.id) {
    req.params.id = req.body.id;
    return TodoController.updateStatus(req, res);
  }
  return res.status(400).json({ error: 'Missing todo id' });
})
app.put('/todo/updateStatus', (req, res) => {
  if (req.body && req.body.id) {
    req.params.id = req.body.id;
    return TodoController.updateStatus(req, res);
  }
